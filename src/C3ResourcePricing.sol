...
contract C3ResourcePricing {
    ...
    enum ResourceType { VirtualMachine, Volume }
    ...
    function createResource(uint256 id, string calldata _name, uint256 _pricePerHour, ResourceType _resourceType) external onlyOwner {
    ...
    function getResource(uint256 id) external view resourceExists(id) returns (string memory name, uint256 pricePerHour, bool deprecated, ResourceType resourceType) {
